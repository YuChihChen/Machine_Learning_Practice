...
print('model coefficients: {}'.format(classifier.coef_))
...
fig1.plot_ellipse(classifier.means_[0], classifier.covariance_, 'red')
fig1.plot_ellipse(classifier.means_[1], classifier.covariance_, 'green')
...
fig2.plot_ellipse(classifier.means_[0], classifier.covariance_, 'red')
fig2.plot_ellipse(classifier.means_[1], classifier.covariance_, 'green')
